...
<html>
  <head>
   ...
   <% 	/**
   		...
   		if(code!=null && code.equals("Not backLogin")){
			error="账号或密码不正确";
	...
	<s:if test="#session.user!=null">
		...
		if(session.getAttribute("backUser")!=null){
	 	...
	 	<div style="width: 100%;background-color:#fff" >
			<center><img alt="深圳无人机协会" src="<%=path %>/images/logo.jpg" style="margin-top: 30px;margin-bottom: 5px;"><center>
		</div>
	   <div class="container">
		<section id="content">
			<form action="login!backLogin.action" method="post">
				<h1>后台账号登录</h1>
				<div style="font-family: 楷体;">
					账号:<s:textfield  name="backstageUser.userName"/>
				</div>
				<div style="font-family: 楷体;">
					密码:<s:password  name="backstageUser.userPassword" />
				</div>
				 <div class="">
